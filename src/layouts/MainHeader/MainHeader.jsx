...
import { FaSun, FaMoon } from "react-icons/fa"; // React Icons ইম্পোর্ট করা হয়েছে
          ...
          <div className="flex items-center ml-4">
            <button
              ...
              className={`
                ...
                ${
                  theme === "dark-mode"
                    ? "bg-[#152E6C]" // Dark mode base background
                    : "bg-[#A00000]" // Light mode base background
                }
            ...
            >
              ...
              <span
                className={`
                  ...
                  ${
                    theme === "light-mode"
                      ? "translate-x-0 bg-background text-white border border-white " // Light mode active slider background
                      : "translate-x-full bg-background text-white border border-white " // Dark mode active slider background
                  }
                `}
                style={{
                  boxShadow:
              ...
              <span
                className={`
                  ...
                  ${
                    theme === "light-mode"
                      ? "text-white opacity-100" // Light mode এ Dark অপশন Visible
                      : "text-gray-300 opacity-0" // Dark mode এ Dark অপশন Invisible
                  }
                  transition-opacity duration-300
                `}
              >
